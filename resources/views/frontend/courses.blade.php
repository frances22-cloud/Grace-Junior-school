        ...
        <div class="container d-flex align-items-center">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="{{ url('teachers') }}" class="nav-link">Events and Activities</a></li>
                    <li class="nav-item active"><a href="{{ url('courses') }}" class="nav-link">Academics</a></li>
                </ul>
            </div>
        </div>
    </nav>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="ftco-footer-widget mb-5">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">Orisai (Baghdad), Ngora District</span></li>
                                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+256 782996567/+256788625005</span></a></li>
